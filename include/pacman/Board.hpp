...
private:    
    ...
    std::unique_ptr<Timer> frightenedTimer;
    std::unique_ptr<std::thread> frightenedThread;
    ...
    void drawLargeTile(int tileX, int tileY, int tileSrcCol, int tileSrcRow, bool isRedrawNeeded);
    void drawPacman();
    void drawGhosts();
    ...
    void frightenedModeEndedHandler();
};
